...
const cities = [
    ...
    { name: 'Amsterdam', coordinates: [52.3676, 4.9041], color: 'grey',  country: 'Netherlands', continent: 'Europe', population: '872,680', footprint: '4,743 km²' },
    { name: 'Barcelona', coordinates: [41.3851, 2.1734], color: 'grey',  country: 'Spain', continent: 'Europe', population: '1,620,343', footprint: '101 km²' },
    { name: 'Berlin', coordinates: [52.5200, 13.4050], color: 'grey',  country: 'Germany', continent: 'Europe', population: '3,769,495', footprint: '891.8 km²' },
    { name: 'Buenos Aires', coordinates: [-34.6037, -58.3816], color: 'grey',  country: 'Argentina', continent: 'South America', population: '2,891,000', footprint: '203 km²' },
    { name: 'Copenhagen', coordinates: [55.6761, 12.5683], color: 'grey',  country: 'Denmark', continent: 'Europe', population: '794,128', footprint: '86.2 km²' },
    { name: 'Hong Kong', coordinates: [22.3193, 114.1694], color: 'grey',  country: 'China', continent: 'Asia', population: '7,500,700', footprint: '1,104 km²' },
    { name: 'Istanbul', coordinates: [41.0082, 28.9784], color: 'grey',  country: 'Turkey', continent: 'Asia', population: '15,067,724', footprint: '5,343 km²' },
    { name: 'Milan', coordinates: [45.4642, 9.1900], color: 'grey',  country: 'Italy', continent: 'Europe', population: '1,396,000', footprint: '181 km²' },
    { name: 'Mumbai', coordinates: [19.0760, 72.8777], color: 'grey',  country: 'India', continent: 'Asia', population: '12,478,447', footprint: '603 km²' },
    { name: 'Paris', coordinates: [48.8566, 2.3522], color: 'grey',  country: 'France', continent: 'Europe', population: '2,165,423', footprint: '105 km²' },
    { name: 'Sao Paolo', coordinates: [-23.5505, -46.6333], color: 'grey',  country: 'Brazil', continent: 'South America', population: '11,253,503', footprint: '1,521 km²' },
    { name: 'Tokyo', coordinates: [35.6824, 139.7590], color: 'grey',  country: 'Japan', continent: 'Asia', population: '14,043,000', footprint: '2,194 km²' },

    // Additional cities
    { name: 'New York City', coordinates: [40.7128, -74.0060], color: 'red', country: 'USA', continent: 'North America', population: '8,336,817', footprint: '789 km²' },
...
// JavaScript for Map 3
document.addEventListener('DOMContentLoaded', function () {
    var map3 = L.map('map3').setView([34.0522, -118.2437], 13); // Initialize Map 3
    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
    }).addTo(map3);

    // Add additional setup code for Map 3
});
