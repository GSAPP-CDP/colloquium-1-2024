...
function initializeMap(map) {
    ...
    function loadData() {
        ...
        const headerMapping2 = { name: 'Diameter', latitude: 'Latitude', longitude: 'Longitude' };
        ...
        loadCSV('./1995_Street_Tree_Census_newyork.csv', headerMapping2, { color: 'blue', fillColor: 'blue', fillOpacity: 0.5, radius: 2 }, function(data) {
